...
<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
            ...
            <h4>Processed</h4> </a> 
                         ...
                         <a href="dbrdvendor-order-pending.php" class="list-group-item-order  text-center">
            <h4>Pending</h4> </a> 
                ...
                <a href="dbrdvendor-order-shipped.php" class="list-group-item-order   text-center">
                  ...
                  <a href="dbrdvendor-order-delivered.php" class="list-group-item-order   text-center active">
                  <h4>Delivered</h4>
                ...
                <a href="dbrdvendor-order-dispute.php" class="list-group-item-order  text-center">
                  <h4 >Dispute</h4>
                                ...
                                <tr>
                                        ...
                                        <td class="price text-center"><strong class="label label-success">Delivered</strong></td>
