...
<div class="myaccount-detail">
          ...
          <div class="mydet-account" id="seller">
            <form method="POST" action="{{ asset('/admin/tovendor/edit-Seller-Account') }}" enctype="multipart/form-data">
              @csrf
          ...
          <div class="mydet-account" style="display: none;" id="business">
            <form method="POST" action="{{ asset('/admin/tovendor/edit-business-info') }}" enctype="multipart/form-data">
              @csrf
            <h3>Business Info</h3>
            <div class="mydet-account-inner">
              <table class="table table-borderless">
                ...
                <tr>
                  ...
                  <td>
                    <select class="citiesdropdownfield" name="city" id="" required="required">
                        ...
                        @if(!empty($cities))
                                @foreach($cities as $c)
                                <option value="{{$c->name}}"{{$c->name ==  $storeDetail->city ? 'selected' : ''}}>
                                @endforeach
                                @endif
                      </select>
                  </td>
          ...
          <div class="mydet-account" style="display: none;" id="address">
            ...
            <div class="mydet-account-inner">
              <form method="POST" action="{{ asset('/admin/tovendor/edit-actual-address') }}" enctype="multipart/form-data">
              @csrf
              <table class="table table-borderless">
                <tr>
                  <td style="width: 150px;">
          ...
          <div class="mydet-account" style="display: none;" id="return">
            ...
            <div class="mydet-account-inner">
              <form method="POST" action="{{ asset('/admin/tovendor/edit-return-address') }}" enctype="multipart/form-data">
              @csrf
                      <div class="radioform">
