                	...
                	<div class="add-account-show">
                	    <div class="add-account-show-inner">
                	        ...
                	        <div>
                	            ...
                	            <button type="submit" formaction="{{url('/admin/tovendor/delete-bank-detail/'.$b->id)}}" class=btn btn-danger>Remove</button>
                                </form>
                	        </div>
                	    </div>
                	</div>
		    ...
		    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{ asset('/admin/tovendor/bank-account-save') }}">
