...
.add-form{
    padding: 0px;
            ...
            <div class="add-form">
                <div class="add-form-inner">
                    <div class="top-form-head">
                        <span>New product in {{$typename->name}}</span>
                        <input type="hidden" value="{{$typename}}" name="type_name">
                        <input type="hidden" value="{{$product->category}}" name="cateid">
                        <input type="hidden" value="{{$product->sub_category_id}}" name="scateid">
                        <input type="hidden" value="{{$product->type_id}}" name="sctcateid">
                    </div>
                    <div class="form-all">
                        <div class="form-f">
                                ...
                                <div class="form-f-w" style="display:flex;">
                                  <input type="text" name="weight" value="{{$product->weight}}">
                                   <select name="weightIn">
                                    <option selected disabled>Select</option>
                                    @if(!empty($product->weightIn))
                                    <option value="{{$product->weightIn}}" {{$product->weightIn ==  $product->weightIn ? 'selected' : ''}}>{{$product->weightIn}}</option>
                                    @else
                            ...
                            <div class="form-f-d">
                              <span>Package dimensions — l x b x h</span>
                                <div class="form-f-d" style="display: flex;">
                                  <input type="text" name="Length" value="{{$product->length}}" placeholder="Length">
                                  <input type="text" name="Breath" value="{{$product->breath}}" placeholder="Breath">
                                  <input type="text" name="Height" value="{{$product->height}}" placeholder="Height">
                                <select name="dimensionIn" value="{{$product->dimensionIn}}">
                                  @if(!empty($product->dimensionIn))
                                    <option value="{{$product->dimensionIn}}" {{$product->dimensionIn ==  $product->dimensionIn ? 'selected' : ''}}>{{$product->dimensionIn}}</option>
                                    @else
                          ...
                          <div class="col-sm-4">
                            <div class="form-f-w">
                              <span>Starting Price</span>
                                <div class="form-f-w" style="display: flex;">
                                 <input type="number" name="starting_price" value="{{$product->price}}" placeholder="Starting Price">
                                </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-all">
                        <div class="row">
                            ...
                            <div class="form-f-a">
                              <span>Brand Name *</span>
                                <div style="display:flex;">
                                  <input type="text" name="brand" value="{{$product->brand_id}}" >
                                   @error('brand')
                          <div class="alert alert-danger">{{ $message }}</div>
                          @enderror
                                </div>
                          ...
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Model no</span>
                                  <input type="text" name="model_no" value="{{$product->model_no}}">
                                  @error('model_no')
                          <div class="alert alert-danger">{{ $message }}</div>
                          @enderror
                            </div>
                          ...
                          @if($typename->name === "Tops & Tunis")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                                <option value="" disabled selected>-- Select --</option>
                                @if(!empty($pro_attri->type))
                                    <option value="{{$pro_attri->type}}" {{$pro_attri->type ==  $pro_attri->type ? 'selected' : ''}}>{{$pro_attri->type}}</option>
                                    @else
                          ...
                          @endif
                          @if($typename->name == "Sports Accessories")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="casual" id="casual"> <label for="casual">casual</label>
                          ...
                          @endif
                          @if($typename->name == "Sandals & Sleeper")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="party" id="party"> <label for="party">Party</label>
                          ...
                          @endif
                          @if($typename->name == "Wallet & Clutches")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Style</span>
                               <select name="style" required>
                          ...
                          @endif
                          @if($typename->name == "Ethnic Bottomwear")
                           <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Pattern</span>
                              <select name="pattern" required>
                          ...
                          @endif
                          @if($typename->name == "Kurtas & Kurtis")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Style</span>
                              <select name="style" required>
                          ...
                          @endif
                          @if($typename->name == "Shalwar qamiz")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Style</span>
                              <select name="style" required>
                         ...
                         <!--  ###################################### Women End ################################################################ -->
                          <!--  ###################################### Kid  ################################################################ -->
                          @if($product->category === '510')
                          @if($typename->name == "Accessories")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Style</span>
                              <select name="style" required>
                          ...
                          <!--  ###################################### Kid End ################################################################ -->
                          <!--  ###################################### Beauty ################################################################ -->
                          @if($product->category === '323')
                          @if($product->sub_category_id === '522')
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @if($product->sub_category_id === '523')
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @endif
                          @if($product->sub_category_id === "526")
                          @if($typename->name == "Hairs")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @endif
                          @if($product->sub_category_id === "525")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @endif
                          @if($product->category === '516')
                          @if($typename->name->name === "Home Decor")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @if($typename->name === "Home Fragrance")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @if($typename->name === "Camping & Hiking")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @if($typename->name === "Travel Accessories")
                           <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @endif
                          @if($typename->name === "Travel Wallet & Organizer")
                          <div class="col-sm-4">
                            <div class="form-f-a">
                              <span>Type</span>
                              <select name="type" required>
                          ...
                          @if($typename->name == "T-shirts & Polos")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="party" id="party"> <label for="party">Party</label>
                          ...
                          @endif
                          @if($typename->name == "Formal Shirts")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="party" id="party"> <label for="party">Party</label>
                          ...
                          @endif
        @if($typename->name == "Casual Shirts")
        ...
        @endif
        @if($typename->name == "Formal Trousers")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="FORMAL" id="FORMAL"> <label for="FORMAL">FORMAL</label>
        ...
        @endif
        @if($typename->name == "Men's Shorts & 3/4ths")
                         <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="party " id="party "> <label for="party ">party </label>
        ...
        @endif
        @if($typename->name == "Casual Trousers & Chinos")
                          <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="ethic" id="ethic"> <label for="ethic">ethnic</label>
       ...
       <div class="col-sm-12">
        ...
        @endif
        @if($typename->name == "Swimwear/Beachwear")
        <div class="col-sm-12">
                            <div class="form-f-a" style="display:flex;">
                              <span class="occ-st"> Occasion </span> <br>
                              <input type="checkbox" name="beach" id="beach"> <label for="beach">beach</label>
 ...
 <div class="col-sm-4">
      ...
      <div class="col-sm-12">
       ...
       <div class="col-sm-12">
        ...
        @endif
        @if($typename->name == "Pocket Squares")
        <div class="col-sm-12">
          <div class="form-f-a" style="display:flex;">
            <span class="occ-st"> Occasion </span> <br>
            <input type="checkbox" name="PARTY" id="PARTY"> <label for="PARTY">PARTY</label>
       ...
       <div class="col-sm-12">
        ...
        @endif
                    ...
                    <div class="form-all">
                     ...
                     <b class="basic-info">Basic Information</b><br>
                     <div class="img-sec">
                            <div class="row">
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-1">
                                                ...
                                                <img id="file-ip-1-preview" src="{{ asset('/public/frontend/storage/uploads/'.$product->images) }}">
                                                @else
                                                 <img id="file-ip-1-preview" src="/public/frontend/img/up-img.png">
                                                 @endif                                                 <div id="div-1-close" style="display:none;">
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-2">
                                                ...
                                                @foreach($product_gallery->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-2-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                <img id="file-ip-2-preview" src="/public/frontend/img/up-img.png">
                                                @endif
                                                @endforeach
                                                <img id="file-ip-2-preview" src="/public/frontend/img/up-img.png">
                                                @else
                                         ...
                                         <div class="image-upload-three">
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-3">
                                                 @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(1)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-3-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                <img id="file-ip-3-preview" src="/public/frontend/img/up-img.png">
                                                @endif
                                                @endforeach
                                                <img id="file-ip-3-preview" src="/public/frontend/img/up-img.png">
                                                @else
                                           ...
                                           <div class="image-upload-four">
                                             <div class="center">
                                               <div class="form-input">
                                                 <label for="file-ip-4">
                                                    @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(2)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-4-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                <img id="file-ip-4-preview" src="/public/frontend/img/up-img.png">
                                                @endif
                                                @endforeach
                                                <img id="file-ip-4-preview" src="/public/frontend/img/up-img.png">
                                                @else
                                           ...
                                           <div class="image-upload-five">
                                             <div class="center">
                                               <div class="form-input">
                                                 <label for="file-ip-5">
                                                    @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(3)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-5-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                <img id="file-ip-5-preview" src="/public/frontend/img/up-img.png">
                                                @endif
                                                @endforeach
                                                <img id="file-ip-5-preview" src="/public/frontend/img/up-img.png">
                                                @else
                                           ...
                                           <div class="image-upload-six">
                                             <div class="center">
                                               <div class="form-input">
                                                 <label for="file-ip-6">
                                                    @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(4)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-6-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                ...
                                                <div class="image-upload-seven">
                                                    <div class="center">
                                                      <div class="form-input">
                                                        <label for="file-ip-7">
                                                           @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(5)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-7-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                ...
                                                <div class="image-upload-eight">
                                                    <div class="center">
                                                      <div class="form-input">
                                                        <label for="file-ip-8">
                                                           @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(6)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-8-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                ...
                                                <div class="image-upload-nine">
                                                    <div class="center">
                                                      <div class="form-input">
                                                        <label for="file-ip-9">
                                                           @if(!empty($product_gallery))
                                                @foreach($product_gallery->slice(7)->take(1) as $p)
                                                @if(!empty($p))
                                                <img id="file-ip-9-preview" src="{{ asset('/public/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-10">
                                                 ...
                                                 <img id="file-ip-10-preview" src="{{ asset('/public/frontend/img/uploaded.png') }}">
                                                 @else
                                                 <img id="file-ip-10-preview" src="https://png.pngtree.com/png-vector/20191129/ourlarge/pngtree-image-upload-icon-photo-upload-icon-png-image_2047547.jpg">
                                                 @endif
                      ...
                      <div class="form-all" id="img-show1">
                        ...
                        <div class="color-selected">
                          <div class="c-field">
                            ...
                            @if($product->sub_category  ==498  || $product->sub_category  == 505)
                            <div class="c-field">
                              <label>Size</label><br>
            ...
            <button type="submit" name="editproduct" style="background:#fe9126; color:#fff; padding: 10px 80px; outline:none; border:none; float:right; margin-right: 30px; margin-bottom:30px;" >Save</button>
        </div>
