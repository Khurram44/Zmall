				...
				<div class="col-sm-10 col-res" style="padding: 5px; margin-left: 25px; margin-top:5px; background: #fff; height: 830px;">
					...
					<div class="statement">
					    ...
					    <div class="statement-inner">
					    	...
					    	<div class="order">
					    		<a class="btn btn-primary" data-toggle="collapse" href="#order" role="button" aria-expanded="false" aria-controls="order">Orders <span class="in-tot">Total. PKR 0.00</span></a>
							...
							<div class="shipping">
					    		<a class="btn btn-primary" data-toggle="collapse" href="#shipping" role="button" aria-expanded="false" aria-controls="shipping">Shipping Fee(Paid by customer)<span class="in-tot">Total. PKR 0.00</span></a>
							...
							<div class="zmall">
					    		<a class="btn btn-primary" data-toggle="collapse" href="#zmall" role="button" aria-expanded="false" aria-controls="zmall">Zmall Fee<span class="in-tot">Total. PKR 0.00</span></a>
