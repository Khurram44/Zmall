	...
	<div class="container-fluid bg">
		<div class="row">
			<div class="log-form">
				...
				<form method="POST" action="{{ route('orderflayer') }}" enctype="multipart/form-data" >
                  @csrf
					<div class="form-inner">
						<b>Do you want to order our flayers?</b>
						<div class="custom-select">
							<b>Select Size:</b>
							<select id="select_size" name="select_size" onclick="selectsize();"> 
							...
							<br>
							<b>Select Quantity:</b>
							<select id="select_quantity" name="select_quantity" onclick="selectquantity();">
