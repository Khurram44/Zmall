                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-float col-sm-6">
                                    ...
                                    <img style="width: 80%;" class="preview"  name="image" src="{{ asset('/storage/uploads/'.$GetData->image) }}"/>
                                </div>
                        ...
                        <div class="row clearfix">
                             <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description" id="" class="form-control" required><?php echo $GetData->short_description;?></textarea>
                                        </div>
                                    </div> 
                        </div>
                        <div class="row clearfix">
