           ...
           <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Investment</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <ul>
                            <li>
                                <div class="ad-hom-box ad-hom-box-1">
                                    ...
                                    <p><i class="fa  fa-arrow-up up"></i> Today Investment</p>
                            ...
                            <li>
                                <div class="ad-hom-box ad-hom-box-4">
                                    ...
                                    <div class="ad-hom-view-com">
                                    <p><i class="fa  fa-arrow-up up"></i> Total Investment</p>
                                     ...
                                     <div class="table-responsive table-desi">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "$".number_format(abs($a->amount));?></td>
                                                <td>
                                                     <a href="{{ url('campaign_detail/'.$a->campaign_id)}}" title="View" target="_blank">
                                                         <?php echo $a->project->title;?>
                                                     </a>
                                                    </td>
