                            ...
                            <div class="box-inn-sp">
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="table-desi">
                                       <form method="POST" action="{{ route('addnews') }}"  id="registerForm" class="clearfix" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row clearfix">
                             <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description" id="" class="form-control" required></textarea>
                                        </div>
                                    </div> 
                        </div>
                        <div class="row clearfix">
