           ...
           <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Approved Subscription </a>
                        </li>
                    </ul>
                </div>
               @if(session('status'))
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Manage Approved Subscription </h4>
                                    ...
                                    <div class="table-responsive table-desi">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <td><a href="{{asset('download-trax-slip/'.$u->trax_track_no)}}"><i class="fa fa-print" aria-hidden="true"></i></a></td>
                                            </tr>
                                           @endforeach
                                           @endif
                                        </tbody>
