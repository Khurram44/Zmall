...
.return-icon-desc span:nth-child(2){
    font-size:10px;
    margin:0px;
}
.shipping_header{
...
<section id="services" class="services section-bg" style="padding-bottom:10px ;">
  ...
  display: none;
   ...
   <div class="container">
    ...
    <div class="gall">
      <div class="video_gall" id="video_gall" style="display: none;" style="height: 300px; width: 300px;">
        <video width="300" height="300" controls autoplay>
          <source class="big_vid" src="{{ asset('frontend/storage/uploads/'.$productdetail->video) }}" type="video/mp4">
       
          Your browser does not support HTML video.
        </video>
      </div>
      <div class="img_gall" id="img_gall" style="height: 300px; width: 300px;">
          
        <img src="{{ asset('frontend/storage/uploads/'.$productdetail->images) }}" class="big_img magniflier" style="height: 300px; width: 300px; object-fit: contain;">
    ...
    <div class="img_tumbs">
      <ul>
        ...
        <li onclick="playvid();" class="vid_hover" style="position: relative;"><img src="{{ asset('/frontend/storage/uploads/'.$productdetail->images) }}" class=" play_video">
          <div class="play_button"></div></li>
          @endif
                        <li>
                            <img class="small_img" src="{{ asset('/frontend/storage/uploads/'.$productdetail->images) }}" />
                        </li>
                      
                      @foreach($product_gallery as $pg)
                      
                     <li>
                  <img class="small_img" id="test" src="{{ asset('/frontend/storage/uploads/'.$pg->image) }}" />
                         </li> 
  ...
  ui.glass.on("mouseout", function () {
    ui.glass.off("mousemove", mouseMove);
         ...
         <!--       <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('{{'/frontend/storage/uploads/'.$productdetail->images}}')">-->
         <!--         <img class="big_img" src="{{ asset('/frontend/storage/uploads/'.$productdetail->images) }}" />-->
         <!--       </figure>-->
               <!--<div class="picZoomer">-->
               <!--   <img id="featured" class="big_img" src="{{ asset('/frontend/storage/uploads/'.$productdetail->images) }}">-->
               <!--</div>-->
         <!--   </div>-->
         <!--</div>-->
         <script type="text/javascript">
    ...
    $(".small_img").hover(function(){
      ...
      var a= document.getElementById("video_gall");
      var b= document.getElementById("img_gall");
  ...
  zoomer.style.backgroundPosition = x + "% " + y + "%";
        ...
        <div class="product-details-content">
          ...
          <div class="rating-tab">
            ...
            <div class="rating-tab-b">
                <button style="background: transparent; border:none;"><i class="fa fa-share-alt" aria-hidden="true"></i></button>
                <button  class="icon-btn add_product_to_wishlist wishlist{{base64_encode($productdetail->id)}}" id="{{base64_encode($productdetail->id)}}" style="background: transparent; border:none; box-shadow: none; line-height: unset;"><i class="fa fa-heart-o" aria-hidden="true"></i></button>
          ...
          @if(!empty($Productprice))
            ...
            <span class="product_size_selected" id="{{ $p->id }}">
              <a href="javascript:void();">
                <span style="height: 40px; text-align: center; border: 1px solid #ddd">
                  {{ $p->size }}
                </span>
              </a>
            </span>
         ...
         <div class="col-sm-3">
          ...
          <div class="return_policy" style="margin-top:0px;">
            <div class="return_desc">
              <div class="return-icon">
