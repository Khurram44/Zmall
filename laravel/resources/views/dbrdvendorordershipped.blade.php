...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container">
 ...
 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
            ...
            <h4>Pending</h4> </a> 
                ...
                <a href="dbrdvendor-order-shipped.php" class="list-group-item-order   text-center active">
                  <h4>Shipped</h4>
                </a>
                  ...
                  <h4 >Dispute</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="price text-center"><strong class="label label-success">Shipped</strong></td>
