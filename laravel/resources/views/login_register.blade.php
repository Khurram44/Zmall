				...
				<form>
					<div class="form-inner">
						...
						<div class="inp-field">
							...
							<input type="email" name="email" id="reg_email" tabindex="2" class="form-control" placeholder="Email Address" value="{{$mail}}" style="">
							...
							<div class="inp-field">
							<input type="text" name="email" id="email" tabindex="1" placeholder="Email" value="{{$user->email}}">
						...
						<div id="show-log-bot" style="display: block;">
							...
							<button  type="button" name="login-submit" id="login-submit" class="onSubmit check_login_form" style="display: block;">Login</button>
							<br>
							<a href="/forgot-password/User" style="margin-top:20px; font-weight:bold;">Forgot Password?</a>
					<!-- -------------------/session end--------------------- -->
					...
					<div class="chk">
					<input type="checkbox" name="" required> By signing up, I agree to Zmall's <a href=""> Privacy Policy </a>and <a href="">Terms & Conditions</a> 
					</div>
					<div class="chk">
					<input type="checkbox" name=""> Subscribe to our exclusive offers & promotions
					</div>
					</div>
					...
					@if(Session::get('getemail') == "")
					<button  id="hidbtn" name="hidbtn" style="padding: 10px 0px;">Proceed</button>
					@endif
			</form>
				@if(Session::get('getemail') == "")
