...
.pro-or-img{
 ...
 @media screen and (min-width: 800px){
	...
	<section class="sub" style="margin-top:130px;">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
					<div class="conf-or">
					...
					<div class="rate-or">
						@foreach($orderdetail->take(1) as $d)
						<h2>Hi {{$d->first_name.''.$d->last_name}}!</h2>
						...
						<div class="ship-detail-inner">
							...
							<div class="pro-or-det">
								<div class="pro-or-img">
									<img src="{{ asset('/frontend/storage/uploads/'.$p->productinfo->images) }}" alt="IMG">
								</div>
				...
				<div class="col-sm-4">
					...
					<div class="add-des">
						...
						<p style="text-transform: capitalize;">{{$d->first_name.''.$d->last_name}}</p>
						<p>{{$d->phone}}</p>
						<p>{{$d->address}}</p>
						<p>{{$d->city}}</p>
						<p>{{$d->zip_code}}</p>
