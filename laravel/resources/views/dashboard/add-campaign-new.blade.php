    ...
    <div class="col-sm-10 col-res" style="padding: 5px; padding: 10px 20px; margin-left: 25px; margin-top:5px; width: 82%; background:#fff; padding-bottom: 50px;">
        ...
        <div class="voucher-form">
            <div class="voucher-form-inner">
                ...
                <div id="shop">
                    <form method="POST" action="{{route('savenewcampaign')}}" enctype="multipart/form-data">
                        <div class="form-in">
                            <div class="form-title">
                        ...
                        <input type="hidden" name="voucher_code" id="voucher_code" value="{{$campaign->campaign_code}}">
                        <input type="hidden" name="campaign_id" id="campaign_id" value="{{$campaign->id}}">
                        <input type="hidden" name="starting" id="starting" value="{{$campaign->starting_time}}">
                        <input type="hidden" name="ending" id="ending" value="{{$campaign->ending_time}}">
