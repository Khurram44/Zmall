...
<div class="row">
    <div class="col-sm-10 col-res" style="padding: 0px 10px; margin-left: 25px; width: 82%;">
        <h3 style="font-size: 22px; color: #333; margin-top:10px;">Create New Top Picks</h3>
    </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-in">
                            ...
                            <div class="form-input">
                                <div class="captions">
                                <label class="v-code" style="width: 100%; font-weight:normal;">
                                    <input style="padding-left: 60px;" type="text">
                                   
                                    <small>Collection name is not visible to buyers.</small>
                        ...
                        <h5 style="font-size: 18px;margin-top: 20px;color: #333; font-weight:600;">Selected Products</h5>
                        <div class="voucher-form">
                            <div class="voucher-form-inner">
                        ...
                        <div class="sub-action">
                            ...
                            <button formaction="/Vendor/top-picks" class="button-c">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
