...
<div class="row">
    <div class="col-sm-10 col-res" style="padding: 0px 10px; margin-left: 25px; width: 82%;">
        <h3 style="font-size: 22px; color: #333; margin-top:10px;">Create New Add-on Deal</h3>
    </div>
            ...
            <div class="voucher-form-inner">
                <div class="form-in">
                    ...
                    <div class="form-input">
                        <div class="v-type voc-active" onclick="shop();" id="act-shop"> 
                            ...
                            <span style="margin-left: 10px;">Add-on Discount</span>
                        ...
                        <div class="v-type" onclick="product();" id="act-product">
                            <img src="/frontend/img/v-type1.png">
                            <span style="margin-left: 10px;">Gift with Min. Spend</span>
                ...
                <div id="shop">
                    <form method="POST" action="{{route('savenewvoucher')}}" enctype="multipart/form-data">
                        <div class="form-in">
                            <div class="form-title">
                                <span>Add-on Discount Name</span>
                            </div>
                            <div class="form-input">
                                <div class="captions res-input">
                                    <input type="text" name="voucher_name" required>
                                     <small>Add-on Discount name is not visible to buyers.</small>
                                </div>
                        ...
                        <div class="form-in">
                            <div class="form-title">
                                <span>Add-on Product Purchase Limit</span>
                            </div>
                            <div class="form-input">
                                <div class="captions res-input">
                                    <input type="text" name="voucher_name" required>
                                     <small>Max. number of add-on products that a customer can purchase per order.</small>
                                </div>
                                
                            </div>
                        </div>
                        <h5 style="font-size: 18px;margin-top: 20px;color: #333; font-weight:600;">Add-on Settings</h5>
                        <div class="voucher-form">
                                <div class="voucher-form-inner">
                                   <div class="form-in">
                                    <div class="form-title">
                                        <span> Main Products </span>
                                        <small>A buyer can purchase a maximum of 100 main product items for the same add-on deal.</small>
                                 ...
                                 <div class="voucher-form-inner">
                                   <div class="form-in">
                                    <div class="form-title">
                                        ...
                                        <small>Buyers can enjoy add-on products at a discounted price when they purchase any main product.</small>
                                    </div>
                                    <div class="form-input">
                                        <div class="captions">
                                            <button class="button-s" type="button" data-toggle="modal" data-target="#addproduct">Add Products</button>
                ...
                <div id="product" style="display: none;">
                    ...
                    <form method="POST" action="{{route('savenewvoucher')}}" enctype="multipart/form-data">
                        <div class="form-in">
                            <div class="form-title">
                                <span>Gift with Min. Spend Name</span>
                            </div>
                            <div class="form-input">
                                <div class="captions res-input">
                                    <input type="text" name="voucher_name" required>
                                     <small>Gift with Min. Spend name is not visible to buyers.</small>
                                </div>
                        ...
                        <div class="form-in">
                            ...
                            <div class="form-input">
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <span style="width: 100%; text-align: center;">Spend </span> <input type="text" name="" required> <span style="width: 100%; text-align: center;">to get</span> <input type="text" name="" required> <span style="width: 100%; text-align: center;">free gift(s)</span>
                                </div>
