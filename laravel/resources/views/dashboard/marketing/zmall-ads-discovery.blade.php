...
<div class="row">
    <div class="col-sm-10 col-res" style="padding: 0px 10px; margin-left: 25px; width: 82%;">
        <h3 style="font-size: 22px; color: #333; margin-top:10px;">Create Discovery Ads</h3>
    </div>
                ...
                <div class="form-in">
                    ...
                    <div class="form-input">
                        <div class="v-type voc-active" id="act-shop"> 
                            ...
                            <span style="margin-left: 10px;">Discovery Ads</span>
                        ...
                        <div class="form-in">
                            ...
                            <div class="form-input">
                                <div class="captions res-input">
                                    <input type="number" name="discovery_budget" required>
