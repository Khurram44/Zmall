        ...
        <div class="voucher-top">
            <div class="voucher-left">
                <div class="voucher-left-inner">
                    <div class="title">Add-on Deal List</div>
                    <div class="title-sub">Click here for our user guide on how to create an add-on discount or gift with min. spend.</div>
                </div>
            </div>
            <div class="voucher-right">
                
                <a href="/Vendor/add-on/new" class="top-btn"> <i class="fa fa-plus" aria-hidden="true"></i> Create
                </a>
            </div>
        </div>
