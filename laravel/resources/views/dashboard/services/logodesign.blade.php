...
<div class="row">
				<div class="col-sm-4" style="padding: 5px; margin-left: 25px; height: 100%; margin-top:5px; background: #fff; height: 830px;">
				    ...
				    <div class="lists">
				    	<ul>
				    		<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> 3D Logo Design</a></li>
				    		<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> 2D Logo Design</a></li>
				    		<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Vector Logo Design</a></li>
				    		<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Mascots Logo</a></li>
				    		<li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Letterforms Logo</a></li>
				    	</ul>
				    </div>
				</div>
				<div></div>
				...
				<div class="col-sm-6 form-right" style="padding: 5px; height: 100%; margin-left: 5px; margin-top: 5px; background: #fff; height: 830px;">
				    <div class="form-detail">
				    	<div class="form-inner">
				    		...
				    		<form action="/Vendor/storeservice/LD" method="POST" enctype="multipart/form-data">
