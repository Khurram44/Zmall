                        ...
                        <div class="col-sm-6">
                            <div class="pro-add-left">
                                ...
                                <div class="pro-add-btn">
                                    <button formaction="/Vendor/approved-products">Edit Price</button>
                                    <button formaction="/Vendor/approved-products">Edit Stock</button>
                                </div>
                                <div class="pro-add-btn">
                                    <button formaction="/Vendor/approved-products">Edit Images</button>
                                    <button formaction="/Vendor/approved-products">Edit Attributess</button>
                                </div>
                                </form>
                            </div>
                        </div>
