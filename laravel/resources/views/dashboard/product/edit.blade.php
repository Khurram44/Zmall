...
.add-form{
    padding: 0px;
        ...
        <form  method="POST" action="{{route('savenewproduct')}}" enctype="multipart/form-data">
          @csrf
        <div class="col-sm-10">
            <div class="add-form">
                <div class="add-form-inner">
                    ...
                    <div class="form-all">
                        ...
                        <div class="form-f">
                          ...
                          <textarea id="mytextarea" rows="10" cols="80" name="description">{!! html_entity_decode($product->description) !!}
                          </textarea>
                          @error('description')
                          <div class="alert alert-danger">{{ $message }}</div>
                          @enderror
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-f-w">
                              <span>Starting Price *</span>
                                <div class="form-f-w" style="display: flex;">
                                 <input type="number" name="starting_price" placeholder="Starting Price" value="{{$product->price}}">
                                </div>
                            </div>
                          </div>
                          <div class="col-sm-4">
                            <div class="form-f-w">
                              <span>Discount Price (IF ANY)</span>
                                <div class="form-f-w" style="display: flex;">
                          ...
                          <div class="col-sm-4">
                            <div class="form-f-w">
                              <span>Stock</span>
                                <div class="form-f-w" style="display: flex;">
                                 <input type="number" name="stock" placeholder="Stock" value="{{$product->quantity}}">
                                </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="row">
                                   ...
                                   <div class="image-upload-container col-sm-10">
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-1">
                                                ...
                                                <img id="file-ip-1-preview" src="{{ asset('/frontend/storage/uploads/'.$product->images) }}">
                                                @else
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-2">
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-2-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-3">
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-3-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="image-upload-four">
                                             <div class="center">
                                               <div class="form-input">
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-4-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="image-upload-five">
                                             <div class="center">
                                               <div class="form-input">
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-5-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="image-upload-six">
                                             <div class="center">
                                               <div class="form-input">
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-6-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                         ...
                                         <!-- ************************************************************************************************************** -->
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-7-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-8-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                                ...
                                                @if(!empty($p))
                                                <img id="file-ip-9-preview" src="{{ asset('/frontend/storage/uploads/'.$p->image) }}">
                                                @else
                                           ...
                                           <div class="center">
                                             <div class="form-input">
                                               <label for="file-ip-10">
                                                 ...
                                                 <img id="file-ip-10-preview" src="{{ asset('/frontend/img/uploaded.png') }}">
                                                 @else
