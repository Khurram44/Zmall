    ...
    <div class="col-sm-10" style="width:82%; padding:5px; margin-left:25px; margin-top:5px; background: #fff; height: 830px; overflow: scroll;">
        <div class="pro-top">
            <div class="pro-top-inner">
                ...
                <a href="/Vendor/addproduct"><i class="fa fa-plus-square-o" aria-hidden="true"></i>   Add a New Product</a>
            </div>
                           ...
                           <td>Rs.{{$p->price}}</td>
                            ...
                            <td>
                                <div class="action">
                                   ...
                                   <a href="{{url('Vendor/del-product/'.$p->id)}}"  onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash-o fa-2x" title="Delete" aria-hidden="true"></i></a>
