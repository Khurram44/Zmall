                ...
                <div class="add-form-inner">
                    ...
                    <div class="form-all">
                        <div class="form-f">
                          ...
                          <input type="text" id="title" name="title" minlength="20" title="Please add minimum 20 characters" required>
                          @error('title')
                        ...
                        <div class="form-f">
                          ...
                          <textarea id="mytextarea" rows="10" cols="80" name="description" required>
                          </textarea>
        ...
        @endif
                                         ...
                                         <div class="image-upload-one">
                                           <div class="center">
                                             <div class="form-input">
                                               ...
                                               <input type="file"  name="img_one" id="file-ip-1" accept="image/*" onchange="showPreview(event, 1);" required>
                                             </div>
                    ...
                    <div class="form-all" id="ap1">
                      <div class="color-select">
                        ...
                        <select id="clrsel1" onchange="showimg1();" required>
                          <option value="" disabled selected>--Select--</option>
