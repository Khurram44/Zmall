							...
							<div class="slt-section">
								...
								<div class="slt-section-inner">
									<div class="slt-mang" onclick="bnshow2();">
										<b id="actdiv2"><i class="fa fa-sort-desc" aria-hidden="true"></i> CANCELLED BY SELLER ({{$cancel_no}})</b>
									</div>
									<div class="ordr" id="div2" style="display: none;">
									    @if(!empty($cancel))
									    @foreach($cancel as $p)
										<div class="awa-div">
										    <div class="awa" onclick="showdetails('{{$p->order_id}}');">
...
<script type="text/javascript">
	...
	var z = document.getElementById("bol_id");
		  if (x.style.display === "none") {
		    x.style.display = "block";
