...
<div class="jsformWrapper">
    <form name="jsform" method="post" action="https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/">
        ...
        <input type="hidden" name="pp_MerchantID" value="MC19893">
        <input type="hidden" name="pp_SubMerchantID" value="">
        <input type="hidden" name="pp_Password" value="s3vs994zwy">
        ...
        <div class="formFielWrapper">
            ...
            <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="T20210824114256">
        </div>
        ...
        <input type="hidden" name="pp_TxnDateTime" value="20210824114256">
        <div class="formFielWrapper">
        ...
        <input type="hidden" name="pp_TxnExpiryDateTime" value="20210825114256">
    ...
    <label id="salt" style="display:none;">t4uswt7cs5</label>
    <br><br>
    <div class="formFielWrapper">
