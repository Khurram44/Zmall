...
<div class="jsformWrapper">
    <form name="jsform" method="post" action="https://payments.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform">
        ...
        <input type="hidden" name="pp_MerchantID" value="00171117">
        <input type="hidden" name="pp_SubMerchantID" value="">
        <input type="hidden" name="pp_Password" value="u109hw2z3u">
        ...
        <div class="formFielWrapper">
            ...
            <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="{{$orderRefNum}}">
        </div>

        <div class="formFielWrapper">
            <label class="active">pp_Amount: </label>
            <input type="text" name="pp_Amount" value="100">
        </div>

        <input type="hidden" name="pp_TxnCurrency" value="PKR">
        <input type="hidden" name="pp_TxnDateTime" value="{{$currenttime}}">
        <div class="formFielWrapper">
            <label class="active">pp_BillReference: </label>
            <input type="text" name="pp_BillReference" value="{{$temp_id}}">
        </div>
        ...
        <input type="hidden" name="pp_TxnExpiryDateTime" value="{{$expDate}}">

        <div class="formFielWrapper">
            <label class="active">pp_ReturnURL: </label>
            <input type="text" name="pp_ReturnURL" value="https://zmall.pk/payment-done">
        </div>
    ...
    <label id="salt" style="display:none;">82688w383v</label>
    <br><br>
    <div class="formFielWrapper">
