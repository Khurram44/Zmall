...
<a  href="{{route('addproduct')}}"  class="btn primary-btn" >Add Products</a>
                            ...
                            <table class="shopping-cart-table table">
                               ...
                               @foreach($product as $p)
                                    <tr>
                                        ...
                                        <td class="details">
                                            <a href="product-page.php"><?= wordwrap($p->title, 30, "<br>", true); ?></a>
                                            <ul>
                                                <li><span>{{$p->size}}</span></li>
                                                <li><span>{{$p->color}}</span></li>
                                            </ul>
                                        </td>
                                        <td class="price text-left">{{$p->category}}</td>
                                        <td class="price text-left">{{$p->price}}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{url('del-product/'.$p->id)}}" onclick="return ('Are you sure to delete?')"><i class="fa fa-trash icon-whish"></i></a>
                                            </td>
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center">
                                            <a href="{{url('edit-product')}}"><i class="fa fa-pencil icon-whish"></i></a>
